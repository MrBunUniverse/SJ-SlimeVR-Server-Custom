    ...
    <ReactModal
      ...
      overlayClassName={
        ...
        classNames(
          ...
          'modal-overlay items-center w-full h-full bg-black/60 dark:bg-black/75 backdrop-blur-sm',
          important ? 'z-50' : 'z-40'
        )
      }
      className={
        ...
        classNames(
          ...
          'modal-surface bg-[#FAF9F5] dark:bg-[#1B1915] text-background-10 shadow-2xl border border-black/[0.08] dark:border-white/[0.08] max-w-lg w-full',
          props.appendClasses
        )
      }
    >
