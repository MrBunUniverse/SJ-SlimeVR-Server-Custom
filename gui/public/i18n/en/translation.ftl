...
tracker-recovery-compensating = Compensating, tracker offline
tracker-recovery-hold-still = Hold tracker still
tracker-recovery-validating = Checking alignment
tracker-recovery-recovered = Recovered
tracker-recovery-needs-reset = Automatic recovery unavailable
tracker-recovery-reset-action = Reset tracker
...
settings-sidebar-telemetry = Session Telemetry
...
settings-sidebar-quest-capture = Quest capture
...
settings-general-tracker_mechanics-filtering-type-adaptive_hybrid = Adaptive Hybrid
settings-general-tracker_mechanics-filtering-type-adaptive_hybrid-description = Automatically smooths when stationary and predicts when moving, with built-in Wi-Fi jitter protection.
...
settings-general-dead-tracker-recovery = Dead tracker recovery
settings-general-dead-tracker-recovery-description = Keeps your pose moving when a tracker loses power, then realigns it after you hold it still.
settings-general-dead-tracker-recovery-enabled = Automatically compensate and recover trackers
settings-general-dead-tracker-recovery-chatbox = Show recovery alerts in the VRChat chatbox
